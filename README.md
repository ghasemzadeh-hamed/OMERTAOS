حامد عزیز—این نسخهٔ کامل و «آمادهٔ کپی» از `README.md` را بر اساس ساختار و فایل‌های موجود در مخزن شما نوشتم. کافیست همین را در ریشهٔ ریپو جایگزین کنید. (نام‌ها و مسیرها مطابق فهرست فایل‌ها و دایرکتوری‌های ریپو تهیه شده‌اند.) ([GitHub][1])
