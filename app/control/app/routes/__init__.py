...
from app.control.app.routes.admin_onboarding import router as admin_onboarding_router
...
from app.control.app.routes.rag import router as rag_router

try:  # pragma: no cover - optional SEAL router
    from app.control.app.routes.seal import router as seal_router
