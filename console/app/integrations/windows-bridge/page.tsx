      ...
      <Card className="border-white/10 bg-white/5">
        ...
        <CardContent className="space-y-3 text-sm leading-6 text-white/80">
          <ol className="list-decimal space-y-2 pl-5">
            ...
            <li>\u0633\u0644\u0627\u0645\u062a \u0627\u0648\u0644\u06cc\u0647: <code>curl http://localhost:3000/healthz</code> \u0648 <code>curl http://localhost:8080/health</code>؛ \u0648\u0636\u0639\u06cc\u062a Control \u0627\u0632 dependencies \u067e\u0627\u0633\u062e Gateway \u062e\u0648\u0627\u0646\u062f\u0647 \u0645\u06cc\u200c\u0634\u0648\u062f.</li>
